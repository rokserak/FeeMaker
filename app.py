...
ws = BitMEXWebsocket(endpoint="https://testnet.bitmex.com/api/v1", symbol="ETHUSD", api_key="oTBcvuJzFbqkuhHprfJlngUx", api_secret="nDsBbd5A12peVIqjgmiT46ealYn0aCcw6ziiOTHI8cLpftXs")
symbol = 'ETHUSD'
